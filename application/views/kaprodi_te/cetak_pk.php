          ...
          <table id="example" class="table table-bordered table-striped header-fixed ">
           ...
           <tr data-toggle="modal" data-target="myModal" class="noExl">
               <td><?php echo $i++; ?></td>                
                ...
                <td><?php echo anchor(base_url()."kaprodi_te/panjar_print/index/".$proposal->id_proposal.'/Pertama','<span class="glyphicon glyphicon-print text-primary fa-lg" aria-hidden="true" title="Cetak Panjar Kerja"></span>'); ?>   
                </td>
