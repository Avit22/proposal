...
?>
       ...
       <?php echo form_open('kaprodi_ptb/input/update_proses/'.$proposal->id_proposal,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
...
<!-- Prodi -->
        ...
        <div class="form-group">
          <label for="rab" class="col-sm-2 control-label">RAB</label>         
            ...
            <button type="button" onclick="openInNewTab('http://localhost/proposal/kaprodi_ptb/insert_rab')">EDIT RAB</button>
