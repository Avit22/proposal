  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
       ...
       <?php echo form_open('kaprodi_ptb/input/update_proses/',array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
       <?php echo validation_errors(); ?>admin/input/update_proses/
