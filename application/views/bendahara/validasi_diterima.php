    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <h1 class="text-center text-info">PENGESAHAN VALIDASI LAPORAN</h1> <br /><br />
          
 <?php 
foreach($laporane as $laporan) { ?> 
<?php echo form_open('bendahara/validasi/update_review/'.$laporan->id_laporan,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
...
<!-- Nama PJK-->
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'nama_pjk', 'id' => 'nama_pjk', 'class' => 'form-control', 'readonly'=>'true', 'placeholder' => 'Nama PJK','value'=>$laporan->nama_pjk);
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'judul', 'id' => 'judul', 'class' => 'form-control', 'readonly'=>'true', 'placeholder' => 'Masukkan Judul Proposal','rows' => '2','value'=>$laporan->judul);
           echo form_textarea($data); ?>
          </div>
        </div>
