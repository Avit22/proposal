        ...
        <div class="right_col" role="main">
          ...
          <table id="example" class="table table-bordered table-striped header-fixed ">
           ...
           <tr data-toggle="modal" data-target="myModal" class="noExl">
                ...
                <td><?php echo anchor("wd2/validasi/validasi/".$proposal->id_proposal,'<span class="glyphicon glyphicon-check text-primary fa-lg" aria-hidden="true" title="Validasi"></span>'); ?>   
                </td>
