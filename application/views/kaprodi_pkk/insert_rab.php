...
<html lang="en"> 
  ...
  <br />
  <?php echo form_open('kaprodi_pkk/insert_rab/add_rab/'.$id_proposal,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
 ...
 <table class="table table-striped" id="myTable">
    ...
    if(isset($rab)){
      foreach ($rab as $row){
      echo "<tr>";
      echo "<td>".$row->barang."</td><td>".$row->harga."</td><td>".$row->jumlah."</td><td>".$row->total."</td>"."<td><a href='".base_url('kaprodi_pkk/insert_rab/update/').'/'.$id_proposal.'/'.$row->id."'>UPDATE</a></td><td><a href='".base_url('kaprodi_pkk/insert_rab/delete_rab/').'/'.$id_proposal.'/'.$row->id."'>DELETE</a></td>";
      echo "</tr>";
    }
    }
