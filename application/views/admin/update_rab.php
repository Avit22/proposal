...
<html lang="en"> 
  ...
  <br />
  <?php echo form_open('admin/insert_rab/update_rab/'.$row->id.'/'.$id_proposal,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
    ...
    <?php echo validation_errors(); ?>
      ...
      foreach ($rab as $row){
      ?>
      <input type="hidden" id="iduserlama" name="iduserlama" value="<?php echo $row->id_user; ?>">
      <?php
      }
      }    
      ?>
