...
<br>
  ...
  <?php echo form_open('admin/rekomendasi_rab/add_rab_keu/'.$id_proposal,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
 ...
 <table class="table table-striped" id="myTable">
  ...
  <!-- Catatan Revisi -->
  <?php echo form_open('admin/rekomendasi_rab/tambah_catatan_rab_keu/'.$id_proposal,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
