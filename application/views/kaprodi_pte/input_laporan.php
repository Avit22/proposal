  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
       ...
       <?php echo form_open_multipart('kaprodi_pte/input_laporan/tambah_proses/',array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
...
<!-- Nama PJK-->
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <?php 
           $data = array('name' => 'rincian_biaya', 'id' => 'rincian_biaya', 'class' => 'form-control', 'placeholder' => 'Masukkan Rincian Kegiatan');
           echo form_textarea($data); ?>
          </div>
        </div>
