        ...
        <div class="right_col" role="main">
          ...
          <table id="example" class="table table-bordered table-striped header-fixed ">
           ...
           <tr data-toggle="modal" data-target="myModal" class="noExl">
                ...
                <td><?php echo anchor("kaprodi_pte/detail_rab/detail/".$proposal->id_proposal,'<span class="glyphicon glyphicon-list-alt text-primary fa-lg" aria-hidden="true" title="Rekomendasi RAB"></span>'); ?>   
