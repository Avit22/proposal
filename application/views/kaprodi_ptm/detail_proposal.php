...
<html lang="en"> 
  ...
  <table class="table">
    ...
    echo '
              ...
              echo "<a href='".base_url('kaprodi_ptm/insert_rab/').'/index/'.$proposal->id_proposal."'>INSERT RAB</a>";
             } endforeach;         
          }
          echo '     
    </tbody>
        ...
        <a href="<?php echo base_url('kaprodi_ptm/proposal_print/index').'/'?><?php echo $proposal->id_proposal ?>"><button type="buttton" class="btn btn-success">PRINT</button> </a>
