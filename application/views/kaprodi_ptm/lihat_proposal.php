        ...
        <div class="right_col" role="main">
          ...
          <table id="example" class="table table-bordered table-striped header-fixed ">
           ...
           <tr data-toggle="modal" data-target="myModal" class="noExl">
                ...
                <td><?php echo anchor("kaprodi_ptm/edit_proposal/edit/".$proposal->id_proposal,'<span class="glyphicon glyphicon-edit text-primary fa-lg" aria-hidden="true" title="Edit Proposal"></span>'); ?>   
                </td>
                <td>
                <?php echo anchor("kaprodi_ptm/input/hapus/$proposal->id_proposal",'<span class="glyphicon glyphicon-trash text-danger fa-lg" aria-hidden="true" title="Hapus Proposal"></span>',array('onClick' => "return confirm('Anda yakin data ini akan di HAPUS ?')")); ?>
                </td>      
            </tr>
            <?php } endforeach; } ?>
