    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="text-center" style="font-size:30px;"> LIHAT REKOMENDASI ITEM</div><br />
          <table id="example" class="table table-bordered table-striped header-fixed ">
            ...
            <tr>
              ...
              <th>Nama PJK</th>
              <th>Tangal Terkirim</th>
              <th>Catatan Staf PPK</th>
           ...
           <tr data-toggle="modal" data-target="myModal" class="noExl">
                ...
                <td><?php echo $proposal->catatan_wd2; ?></td>
                <td><?php echo anchor("dekan/detail_item/detail/".$proposal->id_proposal,'<span class="glyphicon glyphicon-list-alt text-primary fa-lg" aria-hidden="true" title="Rekomendasi RAB"></span>'); ?>   
