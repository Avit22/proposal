        ...
        <div class="right_col" role="main">
          ...
          <table id="example" class="table table-bordered table-striped header-fixed ">
           ...
           <tr data-toggle="modal" data-target="myModal" class="noExl">
                ...
                <td><?php echo anchor("kajur_tjp/input_laporan/input/".$proposal->id_proposal,'<span class="glyphicon glyphicon-tags text-primary fa-lg" aria-hidden="true" title="Laporan"></span>'); ?>   
                </td>
