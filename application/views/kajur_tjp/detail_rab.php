...
<table class="table table-striped" id="myTable1">
  ...
  <?php echo form_open('kajur_tjp/insert_rab/add_rab1/'.$id_proposal,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
 ...
 <table class="table table-striped" id="myTable">
    ...
    if(isset($rab)){
      foreach ($rab as $row){
      echo "<tr>";
      echo "<td>".$row->barang."</td><td>".$row->harga."</td><td>".$row->jumlah."</td><td>".$row->total."</td>"."<td><a href='".base_url('kajur_tjp/insert_rab/update1/').'/'.$id_proposal.'/'.$row->id."'>UPDATE</a></td><td><a href='".base_url('kajur_tjp/insert_rab/delete_rab1/').'/'.$id_proposal.'/'.$row->id."'>DELETE</a></td>";
      echo "</tr>";
    }
    }
...
<p><strong>Catatan Revisi RAB Kepada Kasubag Keuangan </strong></p>
  <!-- Catatan Revisi -->
  <?php echo form_open('kajur_tjp/insert_rab/tambah_catatan_rab/'.$id_proposal,array('id' => 'tambah','name' => 'tambah', 'class' => 'form-horizontal')); ?>
