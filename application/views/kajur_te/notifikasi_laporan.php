        ...
        <div class="right_col" role="main">
          ...
          <table id="example" class="table table-bordered table-striped header-fixed ">
           ...
           <tr data-toggle="modal" data-target="myModal" class="noExl">
                ...
                <td><?php echo anchor("kajur_te/input_laporan/edit/".$revisi_laporan->id_laporan,'<span class="glyphicon glyphicon-edit text-primary fa-lg" aria-hidden="true" title="Edit Proposal"></span>'); ?>   
                </td>
