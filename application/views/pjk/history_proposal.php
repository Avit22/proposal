    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="text-center" style="font-size:30px;"> History Proposal </div><br />
          <table id="example" class="table table-bordered table-striped header-fixed ">
            ...
            foreach($proposale as $validasi) : { ?>
           <tr data-toggle="modal" data-target="myModal" class="noExl">
                <td><?php echo $i++; ?></td>
                
                <td><?php echo $validasi->judul; ?></td>
                <td><?php echo $validasi->nama_pjk; ?></td>
                <td><?php echo $validasi->tgl_input; ?></td>
                <td><?php echo $validasi->tgl_validasi; ?></td>
                <td><?php echo $validasi->validator; ?></td>
            </tr>
            <?php } endforeach; } ?>
