...
class Input_laporan extends CI_Controller {
	...
	public function index() {
		...
		if($query = $this->Input_model->get_data_pjk($sessiondata)) {
			...
			$data['proposale'] = NULL;
		$this->load->view('kajur_te/proposalku', $data);
	...
	public function input($id){
		...
		if($query = $this->Input_model->get_data_input_laporan($id)) {
			...
			$data['proposale'] = NULL;
		$this->load->view('kajur_te/input_laporan',$data);
	}
	...
	public function edit($id){
		...
		if($query = $this->Input_model->get_data_laporanbyid($id)) {
			...
			$data['laporane'] = NULL;
		$this->load->view('kajur_te/edit_laporan',$data);
	}
	...
	$name_of_file = "empty.jpg";
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if($this->Input_model->tambah_laporan($data)){
				redirect('kajur_te/laporan_terkirim');
			}
		}
		redirect('kajur_te/laporan_terkirim');
	}
