...
class Input_laporan extends CI_Controller {
	...
	public function edit($id){
		...
		if($query = $this->Input_model->get_data_laporanbyid($id)) {
			$data['laporane'] = $query;
		}
		else
			$data['laporane'] = NULL;
		$this->load->view('pjk/edit_laporan',$data);
	}
   ...
   $this->email->subject('Laporan Kegiatan Masuk');   
   $this->email->message('Menginformasikan Bahwa Telah Masuk Laporan Kegiatan Baru Ke Dashboard Anda'.'<br />'.
