...
class Revisi_rab extends CI_Controller {
	...
	public function index() {
		...
		if($query = $this->Input_model->get_data_revisi_rab_disetujui_akun()) {
			$data['proposale'] = $query;
		}
		else
			$data['proposale'] = NULL;

		$this->load->view('kabag_keu/revisi_rab',$data);
	...
	$this->form_validation->set_rules('penutup', 'Penutup', 'required');
		if ($this->form_validation->run() == FALSE) {
			...
			$tgl = date("Y-m-d");
			$data = array(
				'keu_review' => $this->input->post('validasi_proposal'),
