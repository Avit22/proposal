...
class Validasi extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('kabag_keu/validasi_proposal',$data);		
	}
	
	public function index2() {

				$this->load->view('kabag_keu/cek_proposal');
	...
	public function validasi($id) {
		...
		$this->load->view('kabag_keu/validasi_diterima', $data);
	}	
	...
	$this->form_validation->set_rules('kode', 'Kode Proposal', 'required');
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('kabag_keu/cek_proposal2',$data);
		}
